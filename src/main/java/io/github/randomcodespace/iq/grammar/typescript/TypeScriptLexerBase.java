package io.github.randomcodespace.iq.grammar.typescript;
 ...
 *
 * <p>From antlr/grammars-v4 (MIT License).
 */
public abstract class TypeScriptLexerBase extends Lexer
{
    ...
    {
        bracesDepth++;
        useStrictCurrent = !scopeStrictModes.isEmpty() && scopeStrictModes.peek() ? true : useStrictDefault;
